$(document).ready(function () {
    ...
    $(document).on("click", ".complete-task", function () {
        ...
        parentLi
            .find(".ul1-li-buttons")
            .prepend(
                '<button class="restore-task"><img src="./restore.svg" alt="Restore Task"></button>' // Add a "Restore Task" button
            );
    ...
    function createTaskHTML(task, isCompleted) {
        let taskHtml = `<li class="ul1-li">
                ...
                <div class="ul1-li-buttons">
                  ${
                    isCompleted
                      ? '<button class="restore-task"><img src="./restore.svg" alt="Restore Task"></button>' // If task is completed, show restore button
                      : '<button class="complete-task"><img src="./completed.svg" alt="Complete Task"></button>' +
                        '<button class="edit-task"><img src="./edit.svg" alt="Edit Task"></button>' // If task is uncompleted, show complete and edit buttons
                  }
                  <button class="delete-task"><img src="./delete.svg" alt="Delete Task"></button> <!-- Always show delete button -->
                </div>
              </li>`;
